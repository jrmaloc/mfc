                    ...
                    <div class="card bg-secondary shadow">
                        ...
                        <div class="card-body">
                            <form id="editForm" action="" method="PUT">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                ...
                                                <input type="text" id="input-username"
                                                    ...
                                                    @if ($kid->username) autofocus value="@ {{ $kid->username }}"
                                                    @else
                                                        value="" @endif>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group focused">
                                                ...
                                                <input id="input-address" class="form-control form-control-alternative"
                                                    ...
                                                    @if ($kid->address) value="{{ $kid->address }}"
                                                    @else
                                                        value="" @endif
                                                    type="text">
                                            </div>
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group focused">
                                        <textarea rows="4" id="bio" class="form-control form-control-alternative"
