            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST">
                ...
                <div class="input-group input-group-merge">
                  <div class="form-floating form-floating-outline">
                    <input value="{{old('name')}}" type="text" id="name"
                      ...
                      placeholder="Juan A. Dela Cruz" aria-describedby="name" />
                ...
                <div class="input-group input-group-merge">
                  <div class="form-floating form-floating-outline">
                    <input value="{{old('username')}}" type="text" id="username"
                      ...
                      placeholder="Your Username" aria-describedby="username" />
              ...
              <div class="mb-3 form-password-toggle">
                <div class="input-group input-group-merge">
                  <div class="form-floating form-floating-outline">
                    ...
                    <label for="password" required>Password<i class="text-danger not-italic">*</i></label>
                  </div>
              ...
              <div class="mb-4 form-password-toggle">
                <div class="input-group input-group-merge">
                  <div class="form-floating form-floating-outline">
                    ...
                    <label for="password_confirmation">Confirm Password<i class="not-italic text-danger">*</i></label>
                  </div>
                  <span class="input-group-text cursor-pointer"><i class="mdi mdi-eye-off"></i></span>
                </div>
              </div>
              ...
              <div class="mb-3">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="terms-conditions" name="terms" checked required />
