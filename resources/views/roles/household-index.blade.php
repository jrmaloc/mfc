...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="fw-bold">Household Servant Management</h2>
        </div>
        ...
        <div class="flex justify-end">
            <x-off-canvas class="mb-2" title="Create a new Household Servant" btn_name="create Household servant"
                id="createCanvas">
                <div class="card-body">
                    <form id="createForm" action="{{ route('household.store') }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                @php
                                    $users = \App\Models\User::where('role_id', '<>', 6)->pluck('name', 'id')->toArray();
                                @endphp
            ...
            <div class="mt-3">
                <div class="offcanvas offcanvas-end" tabindex="-1" id="showCanvas" aria-labelledby="showCanvasLabel"
                    ...
                    <div class="offcanvas-header">
                        <h5 id="showCanvasLabel" class="offcanvas-title">Household Servant Details</h5>
