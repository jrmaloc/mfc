...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="fw-bold">Unit Servant Management</h2>
        </div>
        ...
        <div class="flex justify-end">
            <x-off-canvas class="mb-2" title="Create a new Unit Servant" btn_name="create Unit servant" id="createCanvas">
                <div class="card-body">
                    <form id="createForm" action="" method="POST">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                @php
                                    $users = \App\Models\User::where('role_id', '<>', 5)->pluck('name', 'id')->toArray();
                                @endphp
