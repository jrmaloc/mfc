                            ...
                            <form>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" id="input-email"
                                                    ...
                                                    placeholder="jesse@example.com" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                <label class="form-control-label" for="input-first-name">Full
                                                    name</label>
                                                <input type="text" id="input-first-name"
                                                    class="form-control form-control-alternative" placeholder="name"
                                                    value="Lucky" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                ...
                                                <input type="number" id="input-last-name"
                                                    ...
                                                    placeholder="09********" value="Jesse" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-country">Chapter</label>
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group focused">
                                        ...
                                        <textarea readonly rows="4" class="form-control form-control-alternative" placeholder="A few words about you ...">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eos at, voluptates neque quo corrupti placeat?</textarea>
                                    </div>
                                </div>
                            </form>
                        </div>
