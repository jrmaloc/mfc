            ...
            <div class="container-fluid d-flex align-items-center justify-end" style="position: absolute; bottom: 20%;">
                <div class="row">
                    <div class="col-lg-7 col-md-10">
                        <a href="{{ route('kids.edit', ['kid' => $kid->id]) }}" class="btn btn-info">Edit profile
                    ...
                    <div class="card card-profile shadow">
                        ...
                        <div class="card-body pt-0 pt-md-4">
                            ...
                            <div class="text-center">
                                <h3>
                                    {{ $kid->name }}<span class="font-weight-light">, {{ $age }}</span>
                                </h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                ...
                                                <input type="text" id="input-first-name"
                                                    class="form-control form-control-alternative" name="gender" placeholder="name"
                                                    @if ($kid->gender)
                                                        value="{{ $kid->gender }}"
                                                    @else
                                                        value=""
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group focused">
                                                ...
                                                <input type="number" id="input-last-name"
                                                    ...
                                                    placeholder="09********"
                                                    @if ($kid->contact_number)
                                                        value="{{ $kid->contact_number }}"
                                                    @else
                                                        value=""
                                                    @endif readonly>
                                            </div>
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group focused">
                                        <textarea readonly rows="4" class="form-control form-control-alternative"
                                            placeholder="">@if ($kid->bio){{ $kid->bio }}@else A few words about you ... @endif
                                        </textarea>
                                    </div>
                                </div>
                            </form>
