...
@section('content')
    <div class="main-content" style="margin-left: 5%;">
        <!-- Header -->
            ...
            <div class="row">
                    ...
                    <div class="card card-profile shadow">
                            ...
                            <div class="col-lg-3 order-lg-2">
                                <div class="card-profile-image">
                                    <label href="#" for="upload" id="profilePicture">
                                        <img src="{{ URL::asset('assets/img/avatars/1.png') }}" class="rounded-circle">
                        ...
                        <div class="card-body pt-0 pt-md-4">
                            ...
                            <div class="text-center">
                                <h3 class="capitalize">
                                    {{ $kid->nickname }}<span class="font-weight-light">, {{ $age }}</span>
                                </h3>
                            ...
                            <form>
                                <div class="form-check form-switch mb-2">
                                    <input value="Active" class="form-check-input form-control mr-2" name="status"
                                        ...
                                        @if ($kid->status == 'Active') checked @endif />
                                    <label class="form-check-label" for="status">is Active</label>
                                </div>
                                <div class="form-check form-switch mb-2">
                                    <input value="Active" class="form-check-input form-control mr-2" name="status"
                                        type="checkbox" style="width: 38px; height: 20px;" id="status"
                                        @if ($kid->email_verified_at) checked @endif />
                                    <label class="form-check-label" for="status">Email Verified</label>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-xl-8 order-xl-2">
                    <div class="card bg-secondary shadow">
                        ...
                        <div class="card-body">
                            <form id="editForm" action="{{ route('kids.update', ['kid' => $kid->id]) }}" method="PUT">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                ...
                                                <input type="text" id="input-full-name" name="name"
                                                    ...
                                                    @if ($kid->name) autofocus value="{{ $kid->name }}"
                                                    @else
                                                        value="" @endif>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                ...
                                                <input type="text" id="input-username" name="username"
                                                    ...
                                                    @if ($kid->username) value="{{ $kid->username }}"
                                                    @else
                                                        value="" @endif>
                                            </div>
                                        </div>
                                                ...
                                                <select id="input-gender" name="gender"
                                                    ...
                                                    @if ($kid->gender)
                                                        ...
                                                        <option value="brother"
                                                            {{ $kid->gender === 'Brother' ? 'selected' : '' }}>Brother
                                                        </option>
                                                        <option value="sister"
                                                            {{ $kid->gender === 'Sister' ? 'selected' : '' }}>Sister
                                                        </option>
                                                        <option value="others"
                                                            {{ $kid->gender === 'Others' ? 'selected' : '' }}>Others
                                                        </option>
                                                    @else
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group focused">
                                                ...
                                                <input type="tel" id="input-phone"
                                                    ...
                                                    placeholder="09********"
                                                    @if ($kid->contact_number) value="{{ $kid->contact_number }}"
                                                    @else
                                                        value="" @endif>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group focused">
                                                <label class="form-control-label" for="input-area">Area<span
                                                        class="text-danger">*</span></label>
                                                <select id="input-area" name="area"
                                                    ...
                                                    @if ($kid->area)
                                                        ...
                                                        <option value="North"
                                                            {{ $kid->area === 'North' ? 'selected' : '' }}>North
                                                        </option>
                                                        <option value="East"
                                                            {{ $kid->area === 'East' ? 'selected' : '' }}>East
                                                        </option>
                                                        <option value="Central"
                                                            {{ $kid->area === 'Central' ? 'selected' : '' }}>Central
                                                        </option>
                                                        <option value="South"
                                                            {{ $kid->area === 'South' ? 'selected' : '' }}>South
                                                        </option>
                                                    @else
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-chapter">Chapter<span
                                                        class="text-danger">*</span></label>
                                                <select id="input-chapter" name="chapter"
                                                    ...
                                                    @if ($kid->chapter)
                                                        ...
                                                        <option value="Chapter 1"
                                                            {{ $kid->chapter === 'Chapter 1' ? 'selected' : '' }}>Chapter 1
                                                        </option>
                                                        <option value="Chapter 2"
                                                            {{ $kid->chapter === 'Chapter 2' ? 'selected' : '' }}>Chapter 2
                                                        </option>
                                                        <option value="Chapter 3"
                                                            {{ $kid->chapter === 'Chapter 3' ? 'selected' : '' }}>Chapter 3
                                                        </option>
                                                    @else
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group focused">
                                        <textarea rows="4" name="bio" id="bio" class="form-control form-control-alternative"
                                            placeholder="A few words about you ..."></textarea>
                                    </div>
                                    <script>
                                        document.addEventListener("DOMContentLoaded", function() {
                                            document.getElementById('bio').value = '{{ $kid->bio }}';
                                        });
                                    </script>
                                </div>
                                <div class="flex justify-end gap-3">
                                    ...
                                    <button type="button" id="settings-btn" class="btn btn-info px-10"
                                        style="font-size: small;
                                    width: 125px;
                                    height: 30px;
                                    padding: 0 40px;">settings</button>
                                </div>
                            </form>
                        </div>
                    </div>
