...
<x-edit-form passwordRoute="servants.updatePassword" :parameters="['servant' => $servant]" back="servants.index" action="servants.update"
    :model="$servant" :status="$servant->status">
